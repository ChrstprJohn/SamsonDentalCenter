        ...
        <div className='space-y-6'>
            <div className='p-6 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-white/[0.02] shadow-sm'>
                <div className='flex items-center gap-4 mb-6'>
                    <div className='w-14 h-14 rounded-2xl bg-brand-500/10 flex items-center justify-center text-brand-600 font-medium text-xl capitalize'>
                    ...
                    <div>
                        ...
                        <div className={`mt-1 inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[11px] font-medium capitalize  ${
                ...
                <div className='space-y-4'>
                    <div className='grid grid-cols-3 gap-2'>
                        <div className='p-3 rounded-xl bg-gray-50 dark:bg-white/[0.02] text-center border border-gray-50 dark:border-gray-800 transition-colors hover:bg-gray-100/50 dark:hover:bg-white/5'>
                            <span className='block text-[12px] font-bold text-gray-400 capitalize'>Visits</span>
                            <span className='text-sm font-medium text-gray-900 dark:text-white'>{stats.completed}</span>
                        </div>
                        <div className='p-3 rounded-xl bg-gray-50 dark:bg-white/[0.02] text-center border border-gray-50 dark:border-gray-800 transition-colors hover:bg-gray-100/50 dark:hover:bg-white/5'>
                            <span className='block text-[12px] font-bold text-gray-400 capitalize'>No-Show</span>
                            <span className={`text-sm font-medium ${stats.noShow > 0 ? 'text-error-600' : 'text-gray-900 dark:text-white'}`}>{stats.noShow}</span>
                        </div>
                        <div className='p-3 rounded-xl bg-gray-50 dark:bg-white/[0.02] text-center border border-gray-50 dark:border-gray-800 transition-colors hover:bg-gray-100/50 dark:hover:bg-white/5'>
                            <span className='block text-[12px] font-bold text-gray-400 capitalize'>Cancel</span>
            ...
            <div className='space-y-4'>
                ...
                <div className='space-y-2'>
                    ...
                    {history.length === 0 && !loading && (
                        <p className='text-center py-6 text-xs font-bold text-gray-400 capitalize'>New Patient</p>
                    )}
                </div>
            </div>
        </div>
