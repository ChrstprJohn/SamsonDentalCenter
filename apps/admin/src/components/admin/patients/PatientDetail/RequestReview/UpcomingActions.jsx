...
const UpcomingActions = ({ onCheckIn, onNoShow, onBack, actionLoading }) => {
        ...
        <>
            ...
            <Button 
                ...
                className={`px-8 shadow-lg ${
                    confirmModal.type === 'check-in' ? 'bg-success-600 shadow-success-500/20' : 'bg-red-600 shadow-red-600/20'
                }`}
            >
        ...
        <div className='sm:pt-8 sm:border-t border-gray-100 dark:border-gray-800 flex items-center justify-between sm:relative fixed bottom-0 left-0 right-0 sm:bg-transparent bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg sm:p-0 p-4 z-40 sm:border-t-0 border-t'>
            ...
            {confirmModal.isOpen && createPortal(
                <Modal
                    ...
                    title={confirmModal.type === 'check-in' ? 'Patient Check-In' : 'Mark as No-Show'}
                ...
                >
                    <div className='flex flex-col items-center justify-center py-6 text-center space-y-4'>
                        <div className={`w-20 h-20 rounded-3xl flex items-center justify-center ${
                            ...
                            {confirmModal.type === 'check-in' ? <CheckCircle2 size={40} /> : <UserX size={40} />}
                        </div>
                        <div>
