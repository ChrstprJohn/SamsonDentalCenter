        ...
        <div className='space-y-8'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div className='p-5 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-gray-800'>
                    <label className='text-[11px] font-medium text-gray-400 capitalize block mb-4'>Service Details</label>
                    <div className='flex items-start gap-4'>
                        <div className='w-10 h-10 rounded-xl bg-brand-500/10 flex items-center justify-center text-brand-500'>
                            <Stethoscope size={20} />
                        </div>
                        <div>
                            <p className='text-sm font-bold text-gray-900 dark:text-white capitalize'>{formData.service_name}</p>
                            <p className='text-[12px] text-gray-400 font-bold capitalize mt-1'>
                ...
                <div className='p-5 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-gray-800'>
                    <label className='text-[11px] font-medium text-gray-400 capitalize block mb-4'>Schedule</label>
                    <div className='flex items-start gap-4'>
                        <div className='w-10 h-10 rounded-xl bg-brand-500/10 flex items-center justify-center text-brand-500'>
                            <Calendar size={20} />
                        </div>
                        <div>
                            <p className='text-sm font-bold text-gray-900 dark:text-white capitalize'>{formatDate(formData.date)}</p>
            ...
            <div className='p-6 rounded-2xl bg-brand-500/5 border border-brand-500/20'>
                <div className='flex items-center gap-4'>
                    ...
                    <div>
                        <p className='text-[12px] font-medium text-brand-600 dark:text-brand-400 capitalize mb-1'>Confirming visit for:</p>
