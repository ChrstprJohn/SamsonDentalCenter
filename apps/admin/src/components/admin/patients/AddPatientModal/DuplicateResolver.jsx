        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
            ...
            <div className="p-5 rounded-2xl bg-brand-500/[0.03] border border-brand-500/10 relative overflow-hidden">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                    <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-xl bg-brand-500 text-white flex items-center justify-center font-medium shadow-lg shadow-brand-500/20 shrink-0">
                            <UserSearch size={20} />
                        </div>
                        <div>
                            <h5 className="text-[12px] font-medium capitalize text-brand-500/60 leading-none mb-1.5">New Patient Data</h5>
                    ...
                    <div className="flex flex-wrap items-center gap-x-10 gap-y-2">
                        <div className="flex flex-col gap-1">
                            <span className="text-[11px] font-medium text-gray-400 capitalize tracking-tighter">Dob</span>
                        ...
                        <div className="flex flex-col gap-1">
                            <span className="text-[11px] font-medium text-gray-400 capitalize tracking-tighter">Phone</span>
                            <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col gap-1">
                            <span className="text-[11px] font-medium text-gray-400 capitalize tracking-tighter">Email</span>
                            <div className="flex items-center gap-2">
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between px-2">
                    <h5 className="text-xs font-bold text-gray-900 dark:text-white flex items-center gap-2 capitalize">
                        Similar Patients Found
                        <span className="px-2 py-0.5 rounded-full bg-brand-500/10 text-brand-500 text-[12px] font-medium">{duplicates.length}</span>
                    </h5>
                    <div className="flex items-center gap-2">
                        {hasPhoneConflict && (
                            <p className="text-[12px] font-bold text-amber-600 capitalize bg-amber-500/10 px-2 py-1 rounded-lg border border-amber-500/20 flex items-center gap-2">
                                <AlertCircle size={12} /> Phone Conflict
                            </p>
                        )}
                        {hasEmailConflict && (
                            <p className="text-[12px] font-bold text-error-500 capitalize bg-error-500/10 px-2 py-1 rounded-lg border border-error-500/20 flex items-center gap-2">
                    ...
                    <table className="w-full text-left border-collapse min-w-[800px]">
                        <thead>
                            <tr className="bg-gray-50/50 dark:bg-white/5 border-b border-gray-100 dark:border-white/5">
                                <th className="px-5 py-3 text-[12px] font-medium capitalize text-gray-400">First Name</th>
                                <th className="px-4 py-3 text-[12px] font-medium capitalize text-gray-400">Middle</th>
                                <th className="px-4 py-3 text-[12px] font-medium capitalize text-gray-400">Last Name</th>
                                <th className="px-4 py-3 text-[12px] font-medium capitalize text-gray-400">Suffix</th>
                                <th className="px-4 py-3 text-[12px] font-medium capitalize text-gray-400">Dob</th>
                                <th className="px-4 py-3 text-[12px] font-medium capitalize text-gray-400">Phone</th>
                                <th className="px-4 py-3 text-[12px] font-medium capitalize text-gray-400">Email</th>
                                <th className="px-5 py-3 text-right text-[12px] font-medium capitalize text-gray-400">Action</th>
                            </tr>
                        </thead>
                                        ...
                                        <td className="px-5 py-4 text-right min-w-[160px]">
                                            <div className="flex items-center justify-end gap-2">
                                                <Button 
                                                    ...
                                                    className="rounded-lg h-8 px-3 text-[12px] font-medium capitalize border-gray-200 dark:border-white/10 group-hover:border-brand-500 group-hover:text-brand-500 transition-all"
                                                >
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-error-800/80 dark:text-error-200/80 leading-relaxed font-medium">
                                        The email <span className="font-medium underline">{formData.email}</span> is already in use by an unverified profile. 
                    ...
                    {otpSent && (
                        <div className="p-6 rounded-3xl bg-green-50 dark:bg-green-500/5 border border-green-100 dark:border-green-500/20 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="flex flex-col items-center text-center space-y-4">
                                ...
                                <div>
                                    <h6 className="text-base font-bold text-green-900 dark:text-green-100 capitalize">Verification Required</h6>
                                ...
                                <div className="flex items-center gap-3 w-full max-w-[200px]">
                                    <Input 
                                        ...
                                        className="text-center font-medium text-lg h-12 rounded-2xl border-green-200 focus:ring-green-500"
                                    />
                                </div>
                                <Button 
                                    ...
                                    loading={loading}
                                    className="w-full bg-green-600 hover:bg-green-700 shadow-lg shadow-green-500/20 py-4 rounded-2xl font-medium capitalize"
                                >
                                    Confirm & Link
                                </Button>
                                <button onClick={() => setOtpSent(false)} className="text-[12px] font-bold text-gray-400 capitalize hover:text-gray-600 transition-colors">Cancel Linkage</button>
                            </div>
                        </div>
                    )}
                </div>
