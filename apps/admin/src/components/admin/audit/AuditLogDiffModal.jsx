                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                            ...
                            <div className='space-y-4'>
                                <div className='flex items-center gap-2'>
                                    <div className='h-3 w-1 bg-gray-300 dark:bg-gray-700 rounded-full' />
                                    <h5 className='text-[10px] font-black uppercase tracking-widest text-gray-400'>
                                        Original State
                                    </h5>
                                </div>
                                <div className='p-5 bg-gray-50 dark:bg-white/[0.02] rounded-xl border border-gray-100 dark:border-gray-800/50 min-h-[200px] overflow-auto'>
                            ...
                            <div className='space-y-4 relative'>
                                <div className='flex items-center gap-2'>
                                    ...
                                    <h5 className='text-[10px] font-black uppercase tracking-widest text-brand-500'>
                                        Modified State
                                    </h5>
                                </div>
                                <div className='p-5 bg-brand-50/10 dark:bg-brand-500/5 rounded-xl border border-brand-100/50 dark:border-brand-500/20 min-h-[200px] overflow-auto'>
