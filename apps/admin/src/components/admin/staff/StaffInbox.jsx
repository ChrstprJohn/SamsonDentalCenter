        ...
        <div className='flex-grow flex flex-col h-full bg-white dark:bg-white/[0.03] sm:rounded-2xl border-t sm:border border-gray-300 dark:border-gray-800 overflow-hidden shadow-sm'>
            ...
            <div className='px-4 sm:px-6 py-5 border-b border-gray-200 dark:border-gray-800 space-y-4 bg-white dark:bg-transparent'>
                <div className='flex items-center justify-between gap-4'>
                    ...
                    <button 
                        onClick={onAddClick}
                        className='hidden sm:flex items-center gap-3 px-6 py-3 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-lg text-xs font-bold hover:bg-gray-800 dark:hover:bg-gray-100 transition-all active:scale-95 shrink-0 shadow-lg shadow-gray-900/10 dark:shadow-white/5'
                    >
