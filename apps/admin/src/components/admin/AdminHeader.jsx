        ...
        <header className='sticky top-0 flex w-full bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 z-40 lg:border-b transition-colors'>
            <div className='flex items-center justify-between w-full px-3 py-3 lg:px-6 lg:py-4'>
                ...
                <div className='flex items-center gap-3'>
                    <button
                        className='flex items-center justify-center w-10 h-10 text-gray-500 dark:text-gray-400 rounded-lg lg:h-11 lg:w-11 lg:border border-gray-200 dark:border-gray-800 dark:hover:bg-white/5 transition-colors'
                ...
                <div className='flex items-center gap-2 lg:gap-4'>
                    ...
                    <div className='relative'>
                        <button
                            ...
                            className='flex items-center text-gray-700 dark:text-gray-200 dropdown-toggle text-left transition-colors'
                        >
                            ...
                            <>
                                ...
                                <div className='absolute right-0 mt-2 w-[260px] bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-theme-lg z-50 p-3'>
                                    ...
                                    <button
                                        ...
                                        className='flex items-center gap-3 px-3 py-2 mt-2 font-medium text-gray-600 dark:text-gray-400 rounded-lg text-theme-xs hover:bg-gray-50 dark:hover:bg-white/5 w-full text-left transition-colors group'
                                    >
