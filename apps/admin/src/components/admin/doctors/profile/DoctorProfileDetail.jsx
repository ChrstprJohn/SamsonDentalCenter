        ...
        <div className='space-y-4 sm:space-y-6 animate-in fade-in duration-300'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                <div className='p-4 border border-gray-200 dark:border-white/5 rounded-2xl bg-white dark:bg-white/[0.01] shadow-sm'>
                    ...
                    <p className='text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-tight'>Licensed Dental Pro</p>
                </div>
                ...
                <div className='p-4 border border-gray-200 dark:border-white/5 rounded-2xl bg-white dark:bg-white/[0.01] shadow-sm'>
                    ...
                    <p className='text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-tight'>Apr 2024</p>
                </div>
            </div>

            {/* Biography Card */}
            <div className='p-5 sm:p-6 border border-gray-200 dark:border-white/5 rounded-2xl bg-white dark:bg-white/[0.01] shadow-sm'>
                <h4 className='text-[9px] font-black uppercase tracking-widest text-gray-400 mb-4'>Professional Statement</h4>
