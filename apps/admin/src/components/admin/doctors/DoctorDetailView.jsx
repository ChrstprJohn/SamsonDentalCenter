...
const DoctorDetailView = ({ doctor: initialDoctor, onBack, activeTab, updateDoctorProfile, updateDoctorContact, updateDoctorServices }) => {
    ...
    return (
        <div className='flex flex-col grow min-h-0 bg-white dark:bg-white/[0.03] sm:rounded-xl border-t sm:border border-gray-100 dark:border-gray-800 overflow-hidden no-scrollbar'>
            ...
            <Modal isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} className='max-w-[850px] w-[95%] sm:w-full m-auto'>
                                ...
                                <div className='w-full'>
                                    ...
                                    <div className='grid grid-cols-3 gap-3 px-1'>
                                        {AVATARS.map((url, i) => (
                                            ...
                                            >
                                                <img src={url} alt={`Avatar ${i}`} className="w-full h-full object-cover rounded-md group-hover:scale-110 transition-transform duration-300" />
                                                {selectedAvatar === url && (
                                    ...
                                    <div className='grid grid-cols-2 gap-4 pb-0.5 items-end'>
                                        ...
                                        <div className='col-span-1'>
                                            ...
                                            <div className='h-10 px-4 rounded-lg border border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-white/[0.02] flex items-center justify-between'>
                                                <span className={`text-[10px] font-bold uppercase tracking-widest ${isActive ? 'text-brand-500' : 'text-gray-400'}`}>
            ...
            <Modal isOpen={isEditContactModalOpen} onClose={() => setIsEditContactModalOpen(false)} className='max-w-[450px] w-[95%] sm:w-full m-auto'>
