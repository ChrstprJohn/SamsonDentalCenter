            ...
            <div className='p-4 sm:p-6 border border-gray-300 rounded-2xl dark:border-gray-800 bg-white dark:bg-white/[0.03] shadow-sm'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <div className='p-4 border border-gray-200 dark:border-white/5 rounded-2xl bg-gray-50/20 dark:bg-white/[0.01]'>
                        <div className='flex items-center gap-3 mb-4'>
                            ...
                            <h5 className='text-[11px] font-black text-gray-900 dark:text-white uppercase tracking-tight'>Credential Reset</h5>
                        </div>
                        ...
                        <Button variant='outline' className='w-full h-9 sm:h-10 text-[10px] font-black uppercase tracking-widest border-gray-200 dark:border-white/5 rounded-xl'>
                    ...
                    <div className='p-4 border border-gray-200 dark:border-white/5 rounded-2xl bg-gray-50/20 dark:bg-white/[0.01]'>
                        <div className='flex items-center gap-3 mb-4'>
                            ...
                            <h5 className='text-[11px] font-black text-gray-900 dark:text-white uppercase tracking-tight'>Account Access</h5>
                        </div>
                        <p className='text-[11px] text-gray-500 dark:text-gray-400 mb-6 leading-relaxed'>
                        ...
                        <Button variant='outline' className={`w-full h-9 sm:h-10 text-[10px] font-black uppercase tracking-widest rounded-xl ${doctor.is_active ? 'text-red-600 border-red-500/20' : 'text-success-600 border-success-500/20'}`}>
                ...
                <div className='mt-8 pt-6 border-t border-gray-200 dark:border-gray-800'>
                    <div className='flex items-center gap-3 p-4 rounded-xl bg-amber-500/5 border border-amber-500/10'>
                        ...
                        <div>
                            <p className='text-[9px] font-black text-amber-600 dark:text-amber-500 uppercase tracking-widest mb-0.5'>Audit Notice</p>
                            <p className='text-[10px] text-amber-700 dark:text-amber-400/80 font-medium leading-relaxed'>
