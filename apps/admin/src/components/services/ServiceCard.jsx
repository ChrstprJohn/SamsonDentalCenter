            ...
            <div className='relative w-14 h-14 sm:w-full sm:h-48 m-4 sm:m-0 shrink-0 overflow-hidden rounded-lg sm:rounded-none bg-gray-100 dark:bg-gray-800'>
                {service.image_url ? (
                    ...
                    <div className='w-full h-full flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-white/5 dark:to-white/[0.02]'>
                        <span className='text-gray-300 dark:text-gray-700 font-medium capitalize text-[12px]'>
            ...
            <div className='py-4 pr-4 sm:p-6 flex flex-col grow bg-transparent min-w-0 justify-center'>
                <div className='flex items-start justify-between sm:mb-4 gap-2'>
                    <div className='flex flex-col min-w-0'>
                        {/* Tier */}
                        <span className={`text-[clamp(9px,1.2vw,11px)] font-bold text-brand-600 dark:text-brand-400 capitalize  mb-0.5 sm:mb-1.5 transition-all duration-300 ease-in-out`}>
                            {service.tier}
                        </span>
                        
                        {/* Name */}
                        <h4 className={`text-[clamp(14px,1.8vw,18px)] font-medium text-gray-900 dark:text-white font-outfit leading-tight group-hover:text-brand-500 transition-colors capitalize  truncate sm:whitespace-normal transition-all duration-300 ease-in-out`}>
                            {service.name}
                        </h4>
                ...
                <div className='hidden sm:flex items-center gap-[clamp(4px,0.5vw,6px)] mt-auto pt-5 border-t border-gray-200 dark:border-white/5 text-gray-400'>
                    <Clock size={14} />
                    <span className={`text-[clamp(10px,1.2vw,12px)] font-bold font-outfit capitalize  transition-all duration-300 ease-in-out`}>
                        {service.duration}
                    </span>
                </div>
                ...
                <div className='hidden sm:flex mt-4 items-center justify-end text-[11px] font-medium capitalize text-brand-500 hover:text-brand-600 transition-colors'>
