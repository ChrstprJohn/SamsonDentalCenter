...
const AppointmentDetails = () => {
    ...
    const handleCancel = async () => {
        const result = await cancelAppointment('Patient requested cancellation.');
        if (result.success) {
                                ...
                                {isCancellable ? (
                                    <>
                                        ...
                                        {!showCancelConfirm ? (
                                            ...
                                            <div className='p-4 rounded-xl border border-error-100 dark:border-error-500/20 bg-error-50/50 dark:bg-error-500/5 space-y-3'>
                                                <p className='text-sm text-error-700 dark:text-error-400 font-medium'>Are you sure you want to cancel this appointment?</p>
                                                {cancelError && (
                                                ...
                                                <div className='flex gap-2'>
                                                    <button
                                                        ...
                                                        disabled={cancelling}
                                                        className='flex-1 px-3 py-2 bg-error-500 hover:bg-error-600 text-white rounded-lg text-sm font-medium transition-colors disabled:opacity-60'
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={cancelling}
                                                        className='flex-1 px-3 py-2 border border-gray-200 dark:border-white/[0.08] text-gray-600 dark:text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-white/[0.05] transition-colors'
                                                    >
                                                        Keep It
                                                    </button>
                                                </div>
