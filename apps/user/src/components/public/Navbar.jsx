...
const Navbar = () => {
    ...
    return (
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full'>
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <button
                            className={`lg:hidden p-2 rounded-xl transition-all duration-300 ring-1 ${
        ...
        <div
            className={`fixed inset-0 z-[9998] bg-black/20 backdrop-blur-sm transition-opacity duration-300 lg:hidden ${
        ...
        {/* Mobile Sidebar */}
        <aside
            className={`fixed top-0 left-0 bottom-0 z-[9999] w-[280px] bg-white shadow-2xl transform transition-transform duration-300 ease-in-out lg:hidden ${
