...
const DependentSkeleton = () => {
    return (
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-6 shadow-sm flex flex-col h-full animate-pulse">
            {/* Header: Avatar & Name */}
            <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex-1 space-y-2">
                    ...
                    <div className="h-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg w-1/2" />
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="space-y-2">
                    <div className="h-2 bg-gray-50 dark:bg-gray-800/50 rounded-lg w-1/2" />
