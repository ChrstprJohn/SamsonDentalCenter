    ...
    return (
        <div className='rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03] shadow-theme-sm h-full flex flex-col'>
            <div className='flex items-center justify-between mb-6'>
                ...
                <span className='px-2 py-1 text-[12px] font-bold bg-gray-100 text-gray-600 dark:bg-white/[0.05] dark:text-gray-400 rounded-xl capitalize'>
                    Latest
                </span>
            </div>
            ...
            <button className='mt-6 w-full py-2.5 text-xs font-medium text-gray-500 dark:text-gray-400 border border-gray-100 dark:border-gray-800 rounded-xl hover:bg-gray-50 dark:hover:bg-white dark:bg-white/[0.03]/[0.02] transition-colors'>
                Clear All
            </button>
        </div>
    );
