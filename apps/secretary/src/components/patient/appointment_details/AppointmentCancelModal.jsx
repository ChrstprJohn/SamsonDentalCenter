                ...
                <div className='flex items-center justify-between px-6 pt-6 pb-5 border-b border-gray-100 dark:border-gray-800'>
                    <div className='flex items-center gap-4'>
                        ...
                        <div>
                            ...
                            <p className='text-xs text-gray-400 font-medium mt-1 capitalize'>ID: {rawId.slice(0, 8).toUpperCase()}</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                        disabled={cancelling}
                        className='p-2 rounded-xl text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-white dark:bg-white/[0.03]/[0.06] transition-colors disabled:opacity-40'
                    >
