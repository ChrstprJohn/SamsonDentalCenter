...
import { GitMerge, AlertCircle, CheckCircle2, ArrowRight, Loader2, Search, Info, X } from 'lucide-react';
    ...
    return (
        ...
        >
            <ModalHeader 
                ...
                description="Consolidate duplicate profiles into one"
                onClose={resetAndClose}
            />
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-stretch gap-4">
                            ...
                            <div className="flex-1 p-4 rounded-xl bg-brand-50/50 dark:bg-brand-500/5 text-center">
                                <p className="text-[12px] font-medium text-green-600 capitalize mb-2">Keep This</p>
                    ...
                    {step === 'select' ? (
                        ...
                        <div className="grid grid-cols-2 gap-3 w-full">
                            ...
                            <Button 
                                ...
                                variant="danger"
                            >
                                {loading ? <Loader2 size={18} className="animate-spin mr-2" /> : <GitMerge size={18} className="mr-2" />}
                                Execute Merge
                            </Button>
                        </div>
                    )}
