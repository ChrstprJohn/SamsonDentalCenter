        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white dark:bg-gray-900 w-full max-w-2xl rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
                ...
                <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-white/[0.02]">
                    ...
                    <button onClick={resetAndClose} className="p-2 hover:bg-gray-100 dark:hover:bg-white dark:bg-white/[0.03]/5 rounded-full text-gray-400 transition-colors">
                        <X size={20} />
                    </button>
                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    {sourcePatient ? (
                                        <div className="p-4 rounded-xl border-2 border-red-200 dark:border-red-500/20 bg-red-50/30 dark:bg-red-500/5 relative group">
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-xl bg-gray-200 dark:bg-gray-800 flex items-center justify-center font-bold">{sourcePatient.full_name.charAt(0)}</div>
                                                <div>
                                                    <p className="text-sm font-bold text-gray-900 dark:text-white leading-none mb-1">{sourcePatient.full_name}</p>
                                                    <p className="text-[12px] text-gray-500 dark:text-gray-400 font-bold capitalize">{sourcePatient.email || 'No Email'}</p>
                                                </div>
                                            </div>
                                        </div>
                                    ) : (
                                                ...
                                                <div className="absolute z-10 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl shadow-xl overflow-hidden max-h-40 overflow-y-auto">
                                                    {sourceResults.map(p => (
                                                        <button 
                                                            ...
                                                            className="w-full px-4 py-3 text-left hover:bg-gray-50 dark:hover:bg-white dark:bg-white/[0.03]/5 border-b border-gray-50 dark:border-gray-700 last:border-none flex items-center justify-between"
                                                        >
                                ...
                                <div className="space-y-3">
                                    ...
                                    {targetPatient ? (
                                        <div className="p-4 rounded-xl border-2 border-green-200 dark:border-green-500/20 bg-green-50/30 dark:bg-green-500/5 relative group">
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-xl bg-gray-200 dark:bg-gray-800 flex items-center justify-center font-bold">{targetPatient.full_name.charAt(0)}</div>
                                                <div>
                                                    <p className="text-sm font-bold text-gray-900 dark:text-white leading-none mb-1">{targetPatient.full_name}</p>
                                                    <p className="text-[12px] text-gray-500 dark:text-gray-400 font-bold capitalize">{targetPatient.email || 'No Email'}</p>
                                                </div>
                                            </div>
                                        </div>
                                    ) : (
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-stretch gap-4">
                                <div className="flex-1 p-4 rounded-xl bg-gray-50 dark:bg-white/5 text-center">
                                    ...
                                    <p className="text-[12px] text-gray-500 dark:text-gray-400">{sourcePatient.email}</p>
                                </div>
                                ...
                                <div className="flex-1 p-4 rounded-xl bg-brand-50/50 dark:bg-brand-500/5 text-center">
                                    ...
                                    <p className="text-[12px] text-gray-500 dark:text-gray-400">{targetPatient.email}</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button 
                                    ...
                                    className="py-3.5 border border-gray-200 dark:border-gray-800 text-gray-600 dark:text-gray-400 rounded-xl font-bold text-sm hover:bg-gray-50 dark:hover:bg-white dark:bg-white/[0.03]/5 transition-all"
                                >
                                    Cancel
                                </button>
                                <button 
