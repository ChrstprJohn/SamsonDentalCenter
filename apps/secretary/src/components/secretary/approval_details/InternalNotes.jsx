        ...
        <div className='bg-white dark:bg-gray-800/40 border border-gray-200 dark:border-gray-800 rounded-2xl mx-4 sm:mx-0 p-4 sm:p-8 shadow-theme-xs'>
            <div className='w-full'>
                <div className='flex items-center justify-between mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-gray-100 dark:border-white/5'>
                    <h3 className="text-[11px] font-medium text-gray-400 dark:text-gray-500 capitalize flex items-center gap-2">
                        <StickyNote size={14} className="text-amber-500" /> Internal Staff Notes
                    </h3>
                    <span className={`text-[11px] font-bold capitalize  transition-opacity duration-300 ${isSavingNote ? 'text-brand-500 opacity-100' : saveSuccess ? 'text-success-500 opacity-100' : 'opacity-0'}`}>
            ...
            <div className="relative group">
                ...
                <div className="absolute bottom-3 right-3 transition-opacity">
                    <button 
                        ...
                        className="px-3 py-1.5 bg-brand-50 dark:bg-brand-500/10 text-brand-700 dark:text-brand-400 font-bold text-xs capitalize rounded-xl hover:bg-brand-100 dark:hover:bg-brand-500/20 active:scale-95 transition-all shadow-theme-sm border border-brand-100 dark:border-brand-500/20"
                    >
                        Save
                    </button>
                </div>
