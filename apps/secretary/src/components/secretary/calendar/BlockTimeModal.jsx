                            ...
                            <div className="grid grid-cols-2 gap-4 p-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        className="w-full h-9 px-3 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl text-[13px] font-bold focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all outline-none text-gray-900 dark:text-white"
                                    />
                                </div>
                                <div>
                    ...
                    <div className="md:w-[40%] flex flex-col gap-5 md:pl-2">
                        ...
                        <div className={`transition-all duration-300 flex-grow flex flex-col ${blockModalMode === 'block' ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
                            ...
                            <select 
                                ...
                                className="w-full h-9 shrink-0 px-3 rounded-xl border-2 border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-[13px] font-bold focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all outline-none text-gray-900 dark:text-white"
                            >
                            ...
                            {blockReason === 'other' && (
                                <div className="mt-2 animate-fade-in flex-grow flex flex-col min-h-[50px]">
                                    <textarea 
                                        ...
                                        className="w-full h-full flex-grow text-[13px] font-bold bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-800 rounded-xl px-3 py-2 text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all resize-none"
                                    />
                                </div>
                            )}
                        </div>
                                                ...
                                                <div className="flex-grow">
                                                    ...
                                                    <div className="space-y-1">
                                                        ...
                                                        <div className="flex items-center gap-3">
                                                            <p className="text-[11px] font-medium text-gray-500 dark:text-gray-400 flex items-center gap-2">
