        ...
        >
            ...
            <div className="flex items-start justify-between relative z-10">
                <div className="flex items-center gap-3 sm:gap-4">
                    <div className="relative shrink-0 group/avatar">
                        ...
                        <div className="w-14 h-14 sm:w-16 sm:h-16 relative z-10 overflow-hidden border-2 border-white dark:border-gray-800 flex items-center justify-center bg-gradient-to-br from-brand-400 to-brand-600 text-white font-bold text-xl shadow-sm-md rounded-[1.1rem] group-hover/avatar:scale-105 transition-transform duration-500">
                            {doc.photo_url ? (
                    ...
                    <div>
                        <h3 className="font-bold text-base sm:text-lg text-gray-900 dark:text-white group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors duration-300 leading-tight mb-0.5">{doc.full_name}</h3>
                        <p className="text-[11px] sm:text-xs text-brand-600 dark:text-brand-400 font-bold capitalize">
                            {doc.title || (doc.tier === 'specialized' ? 'Specialist' : 'General Dentist')}
                        </p>
                    </div>
                </div>
                <div className={`inline-flex items-center gap-1 rounded-full border px-2 py-1 sm:px-2.5 sm:py-1 text-[11px] sm:text-[12px] font-medium capitalize  transition-all duration-300 shadow-sm shrink-0 ${
                    doc.is_active 
            ...
            <div className="mt-5 sm:mt-6 space-y-2 relative z-10 pt-4 border-t border-gray-100/80 dark:border-gray-800/80">
                <div className="flex items-center gap-3 text-xs sm:text-sm text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors duration-300">
                    ...
                    <span className="font-semibold tabular-nums">{doc.phone || '+1 (555) 000-0000'}</span>
                </div>
                <div className="flex items-center gap-3 text-xs sm:text-sm text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors duration-300">
