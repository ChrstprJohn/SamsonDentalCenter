...
const ApprovalsPage = () => {
    ...
    return (
        <div className="flex flex-col h-full w-full max-w-full overflow-x-hidden">
            <div className="max-w-[1536px] mx-auto w-full flex flex-col h-full pb-8">
                <PageBreadcrumb 
                    pageTitle={breadcrumbTitle} 
                    subtitle={selectedId ? 'Review detailed request information and history.' : 'Review and manage incoming appointment booking requests.'}
                ...
                <div className="flex-1 min-h-0 flex flex-col sm:mb-6 px-0 sm:px-6 md:px-8">
                    {selectedId ? (
                        <ApprovalDetailView 
